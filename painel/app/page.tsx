...
// Arquitetura Modular (Certifique-se de que os arquivos existem em ../components/)
...
export default function HubGovernanca() {
  ...
  // Pegando os dados organizados do seu novo Hook
    ...
    <div className={`flex h-screen w-full overflow-hidden transition-colors duration-500 ${theme.bg}`}>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="absolute -top-[10%] -left-[10%] w-[60%] h-[60%] rounded-full bg-[#0033A0]/20 blur-[150px] will-change-transform" 
        />
      </div>
