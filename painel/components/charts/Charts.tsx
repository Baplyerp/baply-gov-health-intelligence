...
export const AreaVisual = memo(({ data, isLight }: { data: any[], isLight: boolean }) => (
  <ResponsiveContainer width="100%" height="100%">
    <AreaChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
      ...
      <Area type="monotone" dataKey="projetado" stroke="#FFD100" strokeWidth={3} fillOpacity={1} fill="url(#colorProjetado)" name="Preditivo" animationDuration={1500} />
...
export const RadarVisual = memo(({ data, isLight }: { data: any[], isLight: boolean }) => (
  <ResponsiveContainer width="100%" height="100%">
